...
<body>
	<% 
		Item item = (Item)request.getAttribute("DelInformation");
	%>
	<div style="margin:20px;">
	    ...
	    %>
		<form  action="<%=basePath%>itemDelDone.action" method="post">
		...
		<div class="btn-group btn-group-justified" role="group" aria-label="...">
            <div class="btn-group" role="group">
                <button type="submit" class="btn btn-default">取消删除</button>
            </div>
        </div>
		</form>
		<%
